...
<body style="margin:0;padding:0;background:#f0f4f8;font-family:'Segoe UI',Arial,sans-serif;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 20px;color:#4a5568;font-size:15px;line-height:1.6;">
                We received a request to reset the password for your TaskFlow ERP account.
                Click the button below to choose a new one.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:8px 0 28px;">
                    <a href="\${url}" style="display:inline-block;background:linear-gradient(135deg,#4F46E5,#7C3AED);color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:14px 40px;border-radius:10px;">
                      Reset Password &rarr;
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin:0;color:#a0aec0;font-size:12.5px;line-height:1.5;word-break:break-all;">
  ...
  const fromAddress = process.env.RESEND_FROM_EMAIL || 'TaskFlow ERP <onboarding@resend.dev>'
  const subject = \`Reset your TaskFlow ERP password\`
